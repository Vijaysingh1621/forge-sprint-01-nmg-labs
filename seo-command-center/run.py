...
def main():
    ...
    # LLM-driven fixes require a local Ollama instance (optional enhancement)
    # Skip if Ollama is not available; set empty fixes to satisfy the report contract
    server.seo_set_fixes(titles=[], redirect_map=[])
